...
import kodlamaio.northwind.dataAccess.abstracts.ProdactDao;
...
public class ProductManager implements ProductService{
	...
	private ProdactDao productDao;
	
	@Autowired
	public ProductManager(ProdactDao productDao) {
		super();
	...
	public DataResult<List<ProductWithCategoryDto>> getProductWithCategoryDetails() {
		...
		(this.productDao.getProductWithCategoryDetails(), "Veriler Listelendi");
	}
